#!/usr/bin/env python3
"""
Strict cleanup for swings directory.
...
print()
print("="*70)
print("  SWINGS DIRECTORY STRICT CLEANUP")
...
files_dirs = list(SWINGS_DIR.glob("*_Files"))
...
for files_dir in files_dirs:
    ...
    label = files_dir.name[:60] + "..." if len(files_dir.name) > 60 else files_dir.name
